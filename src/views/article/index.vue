<template>
  <div class="article-container">
    ...
    <div class="main-wrap">
      ...
      <div class="article-detail" v-else-if="article.title">
        ...
        <van-cell class="user-info" center :border="false" >
          ...
          @isfollow="article.is_followed=!article.is_followed"
          class="follow-btn"/>
    ...
    <!-- 收藏按钮 -->
      ...
      :artId="article.art_id"
      @changeCollect="article.is_collected=!article.is_collected"
      />
      <!-- <van-icon
        color="#777"
        name="star-o"
    ...
    <!-- /底部区域 -->
      ...
      <!-- 加载失败：404 -->
      <div class="error-wrap" v-else-if="errState">
...
import likeArticel from '@/components/like-article/index.vue'
import commentList from '@/components/comment-list/index.vue'
import commentPost from '@/components/comment-list/comment-post.vue'
